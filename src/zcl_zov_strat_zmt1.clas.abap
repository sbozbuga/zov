CLASS zcl_zov_strat_zmt1 DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS zcl_zov_strat_zmt1 IMPLEMENTATION.

  METHOD zif_zov_process_strategy~handles.
    rv_yes = xsdbool( iv_otgrp = 'ZMT1' ).
  ENDMETHOD.

  METHOD zif_zov_process_strategy~determine_status.
    IF is_ctx-rechdatum IS NOT INITIAL.
      ...
      IF cs_result-dateclosed IS INITIAL.
        cs_result-dateclosed = is_ctx-rechdatum.
      ENDIF.
    ENDIF.
  ENDMETHOD.
